...
return (
<div class="bg-bgGray  min-h-screen flex ">
...
<div class=" flex ">
    ...
    <div class='flex-grow p-4 bg-violet-100/50 sm:min-w-[80vw] ' >
    <div class="flex-grow min-h-full p-4 px-9 rounded-xl bg-white" >
        {children}
    </div>
    </div>
  </div>
